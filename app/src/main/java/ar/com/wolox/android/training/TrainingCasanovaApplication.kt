...
import ar.com.wolox.android.training.di.DaggerAppComponent
...
class TrainingCasanovaApplication : WolmoApplication() {
    ...
    override fun applicationInjector(): AndroidInjector<TrainingCasanovaApplication> {
